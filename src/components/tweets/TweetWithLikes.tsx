...
const Like = ({ count, liked, tweetId, parentTweetId }: LikeUpdateProps) => {
  ...
  const queryKey = parentTweetId ? tweetKeys.getById(parentTweetId) : tweetKeys.all;
...
const fakeUpdateParentTweet = (
  ...
  const newLikes = liked ? old.tweet._count.likes - 1 : old.tweet._count.likes + 1;
